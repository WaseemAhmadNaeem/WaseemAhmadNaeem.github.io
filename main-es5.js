...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var FeaturedWorkComponent = /** @class */ (function () {
                function FeaturedWorkComponent(projectService) {
                    this.projectService = projectService;
                    this.projects = [];
                    this.registerProjects();
                }
                FeaturedWorkComponent.prototype.registerProjects = function () {
                    var _this = this;
                    /* Registering the Data from projectService*/
                    this.projectService.Projects.subscribe(function (response) {
            ...
            FeaturedWorkComponent.ctorParameters = function () { return [
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var SkillsComponent = /** @class */ (function () {
                ...
                SkillsComponent.prototype.registerSkills = function () {
                    var _this = this;
                    this.skillService.Skills.subscribe(function (response) {
                        _this._frontend = response.filter(function (skill) { return skill.type == "frontend"; }).map(function (el) { return el.value; });
                        _this._backend = response.filter(function (skill) { return skill.type == "backend"; }).map(function (el) { return el.value; });
                        _this._miscellaneous = response.filter(function (skill) { return skill.type == "miscellaneous"; }).map(function (el) { return el.value; });
                    });
                };
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            /* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
            var IProjectService = /** @class */ (function () {
                function IProjectService() {
                }
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var ProjectFirebaseService = /** @class */ (function (_super) {
                __extends(ProjectFirebaseService, _super);
                function ProjectFirebaseService(afStore) {
                    var _this = _super.call(this) || this;
                    _this.afStore = afStore;
                    _this.projects = new rxjs__WEBPACK_IMPORTED_MODULE_5__["BehaviorSubject"]([]);
                    _this.COLLECTION = src_environments_environment_prod__WEBPACK_IMPORTED_MODULE_4__["environment"].COLLECTIONS.PROJECT;
                    _this.registerProjects();
                    return _this;
                }
                ProjectFirebaseService.prototype.registerProjects = function () {
                    var _this = this;
                    this.afStore.collection(this.COLLECTION)
                        ...
                        _this.projects.next(value.docs.map(function (proj) {
                            var tmp = proj.data();
                            tmp.id = proj.id;
                            return tmp;
                        }));
                ...
                Object.defineProperty(ProjectFirebaseService.prototype, "Projects", {
                    get: function () {
                ...
                ProjectFirebaseService.prototype.Get = function (id) {
                    if (id == null || id === undefined) {
                        return this.projects.value;
                    }
                    else {
                        return this.projects.value.filter(function (project) { return project.Id == id; })[0];
                    }
                };
                ProjectFirebaseService.prototype.Update = function (item) {
                    var id = item.Id;
                    delete item.Id;
                ...
                ProjectFirebaseService.prototype.Delete = function (id) {
                    if (id == null || id === undefined)
                        return false;
                    return this.afStore.collection(this.COLLECTION)
                        .doc(id)
                ...
                ProjectFirebaseService.prototype.Add = function (item) {
                    return this.afStore.collection(this.COLLECTION)
                        .add(item);
                };
                ProjectFirebaseService.prototype.DeleteRange = function (id) {
                    var _this = this;
                ...
                return ProjectFirebaseService;
            }(_IProjectService__WEBPACK_IMPORTED_MODULE_2__["IProjectService"]));
            ProjectFirebaseService.ctorParameters = function () { return [
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            /* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
            var ISkillService = /** @class */ (function () {
                function ISkillService() {
                }
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            /* harmony import */ var src_Classes_Status__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! src/Classes/Status */ "./src/Classes/Status.ts");
            var SkillFirebaseService = /** @class */ (function (_super) {
                __extends(SkillFirebaseService, _super);
                function SkillFirebaseService(afStore) {
                    var _this = _super.call(this) || this;
                    _this.afStore = afStore;
                    _this.COLLECTION = src_environments_environment_prod__WEBPACK_IMPORTED_MODULE_3__["environment"].COLLECTIONS.SKILL;
                    _this.skills = new rxjs__WEBPACK_IMPORTED_MODULE_4__["BehaviorSubject"]([]);
                    _this.registerSkillsChanges();
                    return _this;
                }
                // Private Methods
                SkillFirebaseService.prototype.registerSkillsChanges = function () {
                    var _this = this;
                    this.afStore.collection(this.COLLECTION)
                        .ref.where('Status', '==', src_Classes_Status__WEBPACK_IMPORTED_MODULE_6__["Status"].AVAILABLE)
                        .get().then(function (snap) {
                        _this.skills.next(snap.docs.map(function (doc) {
                            var tmp = doc.data();
                            tmp.Id = doc.id;
                            return tmp;
                        }));
                ...
                Object.defineProperty(SkillFirebaseService.prototype, "Skills", {
                    // Public Methods
                    get: function () {
                ...
                SkillFirebaseService.prototype.Get = function (id) {
                    if (id == null || id === undefined) {
                        return this.skills.value;
                    }
                    else {
                        return this.skills.value.filter(function (skill) { return skill.Id === id; })[0];
                    }
                };
                SkillFirebaseService.prototype.Update = function (_item) {
                    var Id = _item.Id;
                    delete _item.Id;
                    return this.afStore.collection(this.COLLECTION)
                        .doc(Id)
                ...
                SkillFirebaseService.prototype.Delete = function (_id) {
                    return this.afStore.collection(this.COLLECTION)
                        .doc(_id)
                        .update({
                        Status: src_Classes_Status__WEBPACK_IMPORTED_MODULE_6__["Status"].DELETED
                ...
                SkillFirebaseService.prototype.Add = function (_item) {
                    return this.afStore.collection(this.COLLECTION)
                        .add(_item);
                };
                SkillFirebaseService.prototype.DeleteRange = function (_id) {
                    var _this = this;
                ...
                return SkillFirebaseService;
            }(_ISkillService__WEBPACK_IMPORTED_MODULE_2__["ISkillService"]));
            SkillFirebaseService.ctorParameters = function () { return [
